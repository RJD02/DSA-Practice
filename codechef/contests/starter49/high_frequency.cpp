...
void solve() {
	...
	// if maxFreq = 2 => N can be of any size...
	// But any operation won't bring F(A) < 2
	// So 2 is the final answer
	// [1, 2, 3] => This frequency will alaways stay 1
	if(maxFreq <= 2)
		cout << maxFreq;
	else
		cout << max(secondMaxFreq, (ll)ceil(maxFreq / 2.0));
	cout << endl;
}
